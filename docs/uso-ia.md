...
| 2026-07-29 | Issue #8 / PR #21 | Redactar y revisar las historias de usuario del cliente y sus criterios de aceptación. | Una propuesta de doce historias sobre identificación, menú, carrito, stock, ubicación, pago, seguimiento, notificaciones y manejo del flujo. | Se contrastó cada historia con la lista obligatoria y los criterios de aceptación del Issue #8, comprobando que todas utilizaran el formato solicitado. | No se realizaron entrevistas ni pruebas con clientes reales. Las historias se derivaron del enunciado y se adaptaron al alcance documentado del MVP con criterios observables sobre el sistema terminado. |
